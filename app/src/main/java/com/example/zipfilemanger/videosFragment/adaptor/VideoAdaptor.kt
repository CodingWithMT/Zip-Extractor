...
class VideoAdaptor(val context: Context, var galleryList: ArrayList<GalleryEnt>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.videos_item_view, parent, false)
